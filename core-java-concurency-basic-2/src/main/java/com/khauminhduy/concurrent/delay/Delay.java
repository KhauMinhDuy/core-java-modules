package com.khauminhduy.concurrent.delay;
...
public class Delay {
	...
	private static void threadSleep(Integer iterations, Integer secondToSleep) {
	...
	private static void timeunitSleep(Integer iterations, Integer secondToSleep) {
		for (Integer i = 0; i < iterations; i++) {
			System.out.println("This is loop iteration number " + i.toString());
			try {
	...
	private static void delayedServiceTask(Integer delayInSecond) {
		ScheduledExecutorService executorService = Executors.newSingleThreadScheduledExecutor();
		executorService.schedule(Delay::someTask1, delayInSecond, TimeUnit.SECONDS);
