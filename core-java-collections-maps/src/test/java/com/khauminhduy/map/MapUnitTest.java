...
public class MapUnitTest {
	...
	public void givenHashMap_whenRetrievesValues_thenCorrect() {
		...
		assertTrue(values.contains("duykhau"));
	...
	public void givenHashMap_whenRetrievesEntries_thenCorrect() {
		...
		for (Entry<String, String> e : entries) {
			...
			assertTrue(value.equals("duykhau") || value.equals("blog"));
		}
	}
	...
	public void whenCallsEqualsOnCollision_thenCorrect() {
		...
		MyKey k1 = new MyKey("firstKey", 1);
		MyKey k2 = new MyKey("secondKey", 2);
		MyKey k3 = new MyKey("thirdKey", 2);

		LOG.info("storing value for k1");
		map.put(k1, "firstValue");

		LOG.info("storing value for k2");
		map.put(k2, "secondValue");

		LOG.info("storing value for k3");
		map.put(k3, "thirdValue");

		LOG.info("retrieving value for k1");
		String v1 = map.get(k1);

		LOG.info("retrieving value for k2");
		String v2 = map.get(k2);

		LOG.info("retrieving value for k3");
