package com.khauminhduy.filevisitor;
...
public class FileSearchExample implements FileVisitor<Path> {
	...
	public static void main(String[] args) throws IOException {
		Path startingDir = Paths.get("C:\\Users\\duykh\\eclipse-workspace\\core-java-modules\\core-java-nio");
		FileSearchExample crawler = new FileSearchExample("temp", startingDir);
