package com.khauminhduy.searching;
...
public class WordIndexerUnitTest {
    ...
    public void givenWord_whenSearching_thenFindAllIndexedLocations() {
        final List<Integer> expectedResult = Arrays.asList(7, 122, 130, 221, 438);
        final List<Integer> actualResult = wordIndexer.findWord(theString, "or");
    ...
    public void givenWord_whenSearching_thenFindAtEndOfString() {
        List<Integer> expectedResult = List.of(480);
